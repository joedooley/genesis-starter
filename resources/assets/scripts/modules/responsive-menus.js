...
(function (document, $, undefined) {
	...
	var genesisMenuParams     = typeof genesis_responsive_menu === 'undefined'
	                            ? ''
	...
	genesisMenu.init = function () {
		...
		var menuIconClass    = typeof genesisMenuParams.menuIconClass !== 'undefined'
		                       ? genesisMenuParams.menuIconClass
		                       : 'dashicons-before dashicons-menu';
		var subMenuIconClass = typeof genesisMenuParams.subMenuIconClass !== 'undefined'
		...
		$('.' + mainMenuButtonClass)
			.addClass(menuIconClass);
		$('.' + subMenuButtonClass)
			.addClass(subMenuIconClass);
		$('.' + mainMenuButtonClass)
			.on('click.genesisMenu-mainbutton', _mainmenuToggle)
			.each(_addClassID);
		$('.' + subMenuButtonClass)
			.on('click.genesisMenu-subbutton', _submenuToggle);
		$(window)
	...
	function _addMenuButtons (toggleButtons) {
		...
		if (menusToCombine !== null) {
			...
			$(_getMenuSelectorString(menusToToggle))
				.before(toggleButtons.menu);

		} else {

			// Apply the main menu toggle to all menus in the list.
			$(_getMenuSelectorString(genesisMenus.others))
				.before(toggleButtons.menu);
	 ...
	 */
	function _doResize () {
		var buttons = $('button[id^="genesis-mobile-"]')
			.attr('id');
	...
	function _addClassID () {
		...
		$this.attr('id', 'genesis-mobile-' + $(nav)
			.attr(id)
			.match(/nav-\w*\b/));
	}
	...
	function _combineMenus (buttons) {
		...
		if ('none' !== _getDisplayValue(buttons)) {
			...
			$(_getMenuSelectorString(combinedMenus))
				.hide();
	...
	function _submenuToggle () {
		...
		others.find('.' + subMenuButtonClass)
		      .removeClass('activated')
		      .attr('aria-pressed', 'false');
		others.find('.sub-menu')
		      .slideUp('fast');
